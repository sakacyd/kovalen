...
class AppPallete {
  ...
  static const Color onSecondaryContainer = Color(0xFF794924);

  static const Color tertiary = Color(0xFF434A57);
  static const Color onTertiary = Color(0xFFFFFFFF);
  static const Color tertiaryContainer = Color(0xFF5B626F);
  static const Color onTertiaryContainer = Color(0xFFD7DEEE);
