...
class GetMessageRoomMessages implements StreamUseCase<List<Message>, GetMessageRoomMessagesParams> {
  final MessageRoomRepository repository;

  GetMessageRoomMessages(this.repository);

  @override
  Stream<Either<Failure, List<Message>>> call(GetMessageRoomMessagesParams params) {
