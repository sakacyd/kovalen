...
class GetMessageRoomMessages implements UseCase<List<Message>, GetMessageRoomMessagesParams> {
  final MessageRoomRepository repository;

  GetMessageRoomMessages(this.repository);

  @override
  Future<Either<Failure, List<Message>>> call(GetMessageRoomMessagesParams params) async {
    return await repository.getMessageRoomMessages(params.roomId);
  }
}
