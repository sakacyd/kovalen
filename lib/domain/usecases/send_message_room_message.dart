...
class SendMessageRoomMessage
    implements UseCase<Message, SendMessageRoomMessageParams> {
  ...
  Future<Either<Failure, Message>> call(
    SendMessageRoomMessageParams params,
  ) async {
...
class SendMessageRoomMessageParams {
  ...
  SendMessageRoomMessageParams({required this.roomId, required this.content});
}
